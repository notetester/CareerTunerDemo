window.SECOND_BRAIN_GRAPH = (() => {
  ...
  const sources = [
    ...
    source("CareerTuner 공개 Obsidian Wiki", "비공개 원본에서 선별한 wiki/index, GRAPH_REPORT, log의 공개 설명 계층입니다.", "https://github.com/notetester/CareerTunerDemo/tree/main/Obsidian/Wiki"),
  ];
